...
class audio_route:
    ...
    def on_call_start(self):
        ...
        self.aplay_mic = Popen([self.aplay, "-D bluealsa:SRV=org.bluealsa,DEV=88:9F:6F:22:BE:55,PROFILE=sco mic.wav"], stdout=PIPE, stdin=self.arec_mic.stdout, shell=False)